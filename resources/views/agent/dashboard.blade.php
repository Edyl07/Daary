    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m9">
                ...
                <h4 class="agent-title">Espace Agent</h4>

                <div class="agent-content">

                    <div class="row">
                        <div class="col s6">
                            <div class="box light-green white-text p-30">
                                <i class="material-icons left">location_city</i>
                                <span class="truncate uppercase bold font-18">Propriétes</span>
                    ...
                    <div class="row">
                        <div class="col s6">
                            <div class="box light-green white-text p-20">
                                <i class="material-icons left font-18">location_city</i>
                                <span class="truncate uppercase bold">Propriétes Recentes</span>
                            </div>
                            <div class="box-content">
                                ...
                                <div class="grey lighten-4">
                                    <a href="{{route('property.show',$property->slug)}}" target="_blank"
                                        ...
                                        <span class="right">{{ $property->price }} Mru</span>
                                    </a>
                                </div>
                                @endforeach
                            </div>
                        ...
                        <div class="col s6">
                            <div class="box light-green white-text p-20">
                                ...
                                <span class="truncate uppercase bold">Mails Recentes</span>
                            </div>
                            <div class="box-content">
