                    ...
                    <table class="striped responsive-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($message->status == 0)
                                    <a href="{{route('agent.message.read',$message->id)}}"
                                    ...
                                    @endif
                                    <a href="{{route('agent.message.replay',$message->id)}}"
                                        class="btn btn-small light-green waves-effect">
                                    ...
                                    <form action="{{route('agent.messages.destroy',$message->id)}}" method="POST"
