    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m9">
                ...
                <h4 class="agent-title">Lire Les MESSAGES</h4>

                <div class="agent-content">

                    <span><strong>A:</strong> <em>{{ $message->name }} < {{ $message->email }}></em></span> <br>
                    <span><strong>Numéro de Téléphone:</strong> {{ $message->phone }}</span>
