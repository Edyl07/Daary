    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m9">
                ...
                <h4 class="agent-title">Liste des Propriétes</h4>
                    ...
                    <table class="striped responsive-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    <span><i
                                            class="material-icons small-comment left">comment</i>{{ $property->comments_count }}</span>
                                </td>

                                <td class="center">
                                    @if($property->featured == true)
                                    <span class="light-green-text"><i class="material-icons small-star">stars</i></span>
                                    @endif
                                </td>
