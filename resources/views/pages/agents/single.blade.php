        ...
        <div class="container" style="margin-top: 100px">
            <div class="row">
                ...
                <div class="col s12 m8">
                    ...
                    <h5 class="uppercase">La liste des propriètés {{ $agent->name }}</h5>
                        ...
                        <div class="card horizontal card-no-shadow border1">
                            ...
                            <div class="card-stacked">
                                <div class="p-20 property-content">
                                    ...
                                    <h5>
                                        {{ $property->price }} Mru
                                        <small class="right p-r-10" style="font-weight: bold">{{ $property->type }} à {{ $property->purpose }}</small>
                                    </h5>
                                </div>
                                ...
                                <div class="card-action property-action">
                                    ...
                                    <span class="btn-flat">
                                        ...
                                        Surfaces: <strong>{{ $property->area}}</strong> Sq Ft
                                    </span>
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Contact de  L'Agent</h5>
                                </li>
                                <li class="collection agent-message">
                                    <form class="agent-message-box" action="" method="POST">
                                        ...
                                        <div class="box">
                                            <button id="msgsubmitbtn" class="btn waves-effect waves-light w100 light-green" type="submit">
                                                SEND
