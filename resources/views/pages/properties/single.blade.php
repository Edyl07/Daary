    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m4">
                <div>
                    <h4 class="left">{{ $property->price }} Mru</h4>
            ...
            <div class="col s12 m8">
                ...
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">Plan de la PROPRIÉTÉS</h5>
                    </div>
                ...
                <div class="card-no-box-shadow card">
                    <div class="p-15 grey lighten-4">
                        <h5 class="m-0">
                            {{ $property->comments_count }} Commentaires
                            @auth
                    ...
                    <div class="single-narebay p-15">
                            ...
                            <div class="content">
                                <div class="author-name">
                                    ...
                                    <span id="commentreplay" class="right replay"
                                        data-commentid="{{ $comment->id }}">Renvoyer</span>
                                    @endauth
                        ...
                        <div class="comment children">
                            <div class="author-image">
                                <span
                                    style="background-image:url({{ Storage::url('users/'.$commentchildren->users->image) }});"></span>
                            </div>
                            <div class="content">
                                <div class="author-name">
                        ...
                        <div class="comment-login">
                            <h6>Veuillez-vous connecté</h6>
                            <a href="{{ route('login') }}" class="btn light-green darken-4">Se connecté</a>
                        </div>
                        @endguest
                ...
                <div class="clearfix">
                    ...
                    <div>
                        <ul class="collection with-header m-t-0">
                            <li class="collection-header grey lighten-4">
                                <h5 class="m-0">Contacté l'agent</h5>
                            </li>
                            <li class="collection-item p-0">
                                ...
                                <div class="p-l-10 p-r-10">
                                    ...
                                    <a style="padding-left: 12px" href="{{ route('agents.show',$property->agent_id) }}"
                                        class="profile-link">
                                        <div style="display: contents;">
                                            <i class="material-icons" style="display: inline-block; font-size: 40px; transform: rotateX(200deg)">local_phone</i>
                                            <span style="display: inline-block; font-weight: bold; transform: translateY(-10px);">{{ $property->user->phone_number }}</span>
                                        </div>
                                    </a>
                                </div>
                                @endif
                    ...
                    <div>
                        <ul class="collection with-header">
                            <li class="collection-header grey lighten-4">
                                <h5 class="m-0">List des Villes</h5>
                            </li>
                    ...
                    <div>
                        <ul class="collection with-header">
                            <li class="collection-header grey lighten-4">
                                <h5 class="m-0">PROPRIÉTÉS CONNEXES</h5>
                            </li>
                            ...
                            <li class="collection-item p-0">
                                <a href="{{ route('property.show',$property_related->id) }}">
                                    <div class="card horizontal card-no-shadow m-0">
                                        ...
                                        @endif
                                        <div class="card-stacked">
                                            <div class="p-l-10 p-r-10 light-green-text darken-4">
                                                <h6 title="{{$property_related->title}}">
                                                    {{ str_limit( $property_related->title, 18 ) }}</h6>
                                                <strong>{{$property_related->price}} Mru</strong>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                $('#procomment-'+commentid).empty().append(
                    `<div class="comment-box">
                        <form action="{{ route('property.comment',$property->id) }}" method="POST">
                            ...
                            <input type="submit" class="btn light-green darken-4" value="Comment">
                        </form>
                    </div>`
                );
            });
