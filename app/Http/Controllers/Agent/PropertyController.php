...
class PropertyController extends Controller
{
    ...
    public function withOutLngLat()
    {
        $properties = Property::all();
        return view('agent.properties.emplacement', compact('properties'));
    }



    public function displayProperty(Request $request, $slug)
    {
        ...
        $lat = $data->latitude;
        $lng = $data->longitude;
        return view('agent.properties.show', compact('property', 'lat', 'lng'));
    }
    ...
    public function position(Request $request, $id)
    {
        ...
        Toastr::success('message', 'Les Coordonnées ont bien mis été à jour');
