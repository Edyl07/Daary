...
// Route::post('like', 'FrontpageController@like')->name('like');
...
Auth::routes();
/* --------------------------SocialLite------------------------------- */
Route::get('login/{provider}', 'Admin\SocialiteController@redirect');
Route::get('login/{provider}/callback', 'Admin\SocialiteController@Callback');
/*---------------------------End Socialite-----------------------------------*/
...
Route::group(['prefix' => 'agent', 'namespace' => 'Agent', 'middleware' => ['auth', 'agent'], 'as' => 'agent.'], function () {
    ...
    Route::post('changepassword', 'DashboardController@changePasswordUpdate')->name('changepassword.update');
    Route::resource('properties', 'PropertyController');
    Route::get('edit/position', 'PropertyController@withOutLngLat')->name('edit.position');
    Route::get('show/position/{slug}', 'PropertyController@displayProperty')->name('show.position');
    Route::post('position/{id}', 'PropertyController@position')->name('update.position');
    Route::post('properties/gallery/delete', 'PropertyController@galleryImageDelete')->name('gallery-delete');
